# Historical development log through 0.3.5

Archived 2026-09-25. Entries below are point-in-time history, NOT current instructions.
Earlier defaults, memory limits, pending work and publication statements may be superseded.
Use [current state](current-state.md) and [agent handoff](agent-handoff.md) for current work.
