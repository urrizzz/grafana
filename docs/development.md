...
- The M2 adapter and M3 compact renderer are implemented locally; M3 owner validation is pending. A runnable [mock metrics exporter](mock-metrics.md) and tests are available.
